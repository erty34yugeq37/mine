...
import (
	...
	mc "ghoulbeam/internal/attacks/game"
	"ghoulbeam/internal/attacks/http"
	tcp "ghoulbeam/internal/attacks/tcp"
	"ghoulbeam/internal/config"
	"ghoulbeam/internal/engine"
	"ghoulbeam/internal/proxy"
	targetpkg "ghoulbeam/pkg/target"
)

func main() {
	zerolog.TimeFieldFormat = time.RFC3339
	root := &cobra.Command{Use: "ghoul", Short: "Ghoul Beam CLI"}
	...
	attackCmd := &cobra.Command{Use: "attack [method] [target]", Short: "Launch an attack", Args: cobra.ExactArgs(2), Example: "ghoul attack http_flood http://example.com"}
